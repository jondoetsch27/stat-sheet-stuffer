...
public class TestConstants {
  ...
  public static final String SPORTS_RADAR_URL = "https://api.sportradar.us/nfl/official/trial";
  public static final String TEAMS_URL = "/v6/en/teams/";
  public static final String PLAYERS_URL = "/v6/en/players/";
  public static final String PROFILE_URL = "/profile.json";
  public static final String ROSTER_URL = "/full_roster.json";
